    ...
    return (
        ...
        <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16">
            ...
            <div className="space-y-4 sm:col-span-2 lg:col-span-1">
                ...
                Solutions Without Limits. Transform your business with Ozyntria Tech's 
            ...
            <div className="space-y-4">
                ...
                <a href="#services" className="block text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                    Web Development
                </a>
                <a href="#services" className="block text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                    Mobile Apps
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                <a href="#about" className="block text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                    About Us
                </a>
                <a href="#portfolio" className="block text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                    Portfolio
                </a>
                <a href="#brand" className="block text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                    Brand Guidelines
                </a>
                <a href="#team" className="block text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                    Our Team
                </a>
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-primary-foreground/80">hello@ozyntria.com</span>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-primary-foreground/80">Global Remote Team</span>
                </div>
                </div>
            </div>
            </div>
