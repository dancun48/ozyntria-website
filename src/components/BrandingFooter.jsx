            ...
            <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16">
                ...
                <div className="space-y-4">
                    ...
                    <div className="group space-y-2">
                        <a href="#home" className="block text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors hover:underline hover:transition-all duration-500">
                            Home
                        </a>
                        ...
                        <a href="#contact" className="block text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors hover:underline hover:transition-all duration-500">
                            Get Started
                        </a>
                    </div>
                </div>
